      ...
      <div className="fixed inset-0 flex w-screen items-center justify-center p-2">
        <DialogPanel className="rounded-2xl max-w-lg space-y-4 flex flex-col gap-2 border-4 border-yellow-400 bg-white px-8 py-6">
          ...
          <div className="flex gap-4">
            <button
              className={`cursor-pointer text-xl text-white text-semibold rounded border-blue-500 px-3 py-1 transition-colors duration-200 border-2 hover:bg-blue-400 hover:border-blue-400 hover:text-white bg-blue-500`}
